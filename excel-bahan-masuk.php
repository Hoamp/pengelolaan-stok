...
$data = mysqli_query($conn, "SELECT * FROM bahan_masuk INNER JOIN bahan ON bahan.id_bahan = bahan_masuk.id_bahan WHERE waktu >= '$dari' AND waktu <= '$sampai'");
?>
